...
class ValidadorTipoDoc {
  ...
  validate() {
    ...
    if (this.tipoDoc !== null && (this.tipoDoc === gCte.TipoDocPasaporte && $("#txtPasaporte").val().trim() !== "") || (this.tipoDoc === gCte.TipoDocRun && $("#txtDni").val().trim() !== "") || (this.tipoDoc === gCte.TipoDocDni && $("#txtRutP").val().trim() !== "")) {
      this.result = true;
...
class ValidadorRutPac {
  constructor(classInvalid, jqid,pasaporte, dni) {
    this.result = false;
    this.classInvalid = classInvalid;
  ...
  validate() {
    ...
    else  if (this.dni.is(":visible") && this.dni.val() === '') {
      this.result = false;
      this.dni.addClass("is-invalid");
    }
    else {
      this.result = true;
      this.dni.removeClass("is-invalid");
...
function stepPacValidate(idTipoAtencion,lstExamenes) {
  let isValid = false;
 let validadorRutPac = new ValidadorRutPac('is-invalid', 'txtRutP','txtPasaporte','txtDni');
