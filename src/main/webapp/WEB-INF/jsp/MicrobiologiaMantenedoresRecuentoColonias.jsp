        ...
        <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
            ...
            <%@page contentType="text/html" pageEncoding="UTF-8" %>
                ...
                <head>
                    ...
                    <title>BiosLIS | MB - Recuento de Colonias</title>
                </head>
                ...
                <body >
                    <div class="row menu-container">
	                    ...
	                    <div class="row d-flex justify-content-center mt-4">
	                    	<jsp:include page="microbiologia/ColonyCountConfig.jsp" />
	                    </div>
                    </div>
                    ...
                    <script
                        src="<%=request.getContextPath()%>/resources/js/microbiologia/MicrobiologiaMantenedoresRecuentoColonias.js"></script>
