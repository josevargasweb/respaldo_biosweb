        ...
        <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
            ...
            <%@page contentType="text/html" pageEncoding="UTF-8" %>
                ...
                <head>
                    ...
                    <title>BiosLIS | MB - Zonas del Cuerpo</title>
                </head>
                ...
                <body >
                    ...
                    <div class="container container-main-content container-configuracion mt-5" >
	                    <div class="row d-flex justify-content-center mt-4">
	                    	<jsp:include page="microbiologia/BodyAreasConfig.jsp" />
	                    </div>
                    </div>
                    ...
                    <script
                        src="<%=request.getContextPath()%>/resources/js/microbiologia/MicrobiologiaMantenedoresZonasCuerpo.js"></script>
