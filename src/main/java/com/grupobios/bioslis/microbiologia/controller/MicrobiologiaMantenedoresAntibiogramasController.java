...
@Controller
public class MicrobiologiaMantenedoresAntibiogramasController {
    
    ModelAndView mav = new ModelAndView();
    
    @RequestMapping("/MicrobiologiaMantenedoresAntibiogramas")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_MICROBIOLOGIA_ANTIBIOGRAMAS);
      ...
      //aqui se inserta la accion que realiza  usuario al ingresar a un modulo***********   
        if(usuario != null) {
	        ...
	        leu.setLeuValornuevo("accede a Configuración de antibiogramas");
