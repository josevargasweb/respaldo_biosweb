...
@Controller
public class MicrobiologiaMantenedoresMicroorganismosController {

    ModelAndView mav = new ModelAndView();

    @RequestMapping("/MicrobiologiaMantenedoresMicroorganismos")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes) {
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_MICROBIOLOGIA_MICROORGANISMOS);
        ...
        if(usuario != null) {
	        ...
	        leu.setLeuValornuevo("accede a Configuración de microorganismos");
