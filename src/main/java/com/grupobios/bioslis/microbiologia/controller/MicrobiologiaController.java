...
public class MicrobiologiaController {
    ...
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_MICROBIOLOGIA);
        ...
        if(usuario != null) {
	        ...
	        leu.setLeuValornuevo("accede a Captura de resultados de Microbiología");
