...
@Controller
public class MicrobiologiaMantenedoresMediosCultivoController {
    
    ModelAndView mav = new ModelAndView();
    
    @RequestMapping("/MicrobiologiaMantenedoresMediosCultivo")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes) {
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_MICROBIOLOGIA_MEDIOSCULTIVO);
        ...
        if(usuario != null) {
	        ...
	        leu.setLeuValornuevo("accede a Configuración de medios de cultivo");
