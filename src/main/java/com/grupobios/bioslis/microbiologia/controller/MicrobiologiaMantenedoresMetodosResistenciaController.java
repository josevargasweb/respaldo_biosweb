...
@Controller
public class MicrobiologiaMantenedoresMetodosResistenciaController {

    ModelAndView mav = new ModelAndView();

    @RequestMapping("/MicrobiologiaMantenedoresMetodosResistencia")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes) {
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_MICROBIOLOGIA_METODOSRESISTENCIA);
        ...
        if( usuario != null) {
	        ...
	        leu.setLeuValornuevo("accede a Configuración de métodos de resistencia");
