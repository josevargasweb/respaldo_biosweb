...
@Controller
public class MicrobiologiaMantenedoresZonasCuerpoController {

    ModelAndView mav = new ModelAndView();

    @RequestMapping("/MicrobiologiaMantenedoresZonasCuerpo")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_MICROBIOLOGIA_ZONASCUERPO);
        ...
        if(usuario != null ) {
	        ...
	        leu.setLeuValornuevo("accede a Configuración de sitio anatómico");
