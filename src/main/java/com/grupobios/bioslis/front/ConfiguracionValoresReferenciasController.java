 ...
 */
@Controller
public class ConfiguracionValoresReferenciasController {

    ModelAndView mav = new ModelAndView();

    @RequestMapping("/ConfiguracionValoresReferencias")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_CONFIGURACION_VALORES_REFERENCIAS);
      ...
      //aqui se inserta la accion que realiza usuario en modulos ***********            
        ...
        if(usuario != null) {
    	    ...
    	    leu.setLeuValornuevo("accede a Configuración de valores de referencia");
