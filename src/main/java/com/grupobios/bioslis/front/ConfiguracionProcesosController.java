 ...
 */
@Controller
public class ConfiguracionProcesosController {
    
    ModelAndView mav = new ModelAndView();
    
    @RequestMapping("/ConfiguracionProcesos")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_CONFIGURACION_PROCESOS);
      ...
      //aqui se inserta la accion que realiza usuario en modulos ***********            
        ...
        if(usuario != null) {
    	    ...
    	    leu.setLeuValornuevo("accede a Configuración de procesos");
