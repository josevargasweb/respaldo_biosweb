...
public class ConfiguracionExamenController {
    ...
    @RequestMapping("/ConfiguracionExamen")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_CONFIGURACION_EXAMEN);
        ...
        LogUsuarioDAO logUsuarioDao = new LogUsuarioDAO();
	        ...
	        leu.setLeuValornuevo("accede a Configuración de exámenes");
