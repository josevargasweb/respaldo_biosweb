 ...
 */
@Controller
public class ConfiguracionAnalizadoresController {
    
    ModelAndView mav = new ModelAndView();
    
    @RequestMapping("/ConfiguracionAnalizadores")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes) {
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_CONFIGURACION_ANALIZADORES);
        ...
        if(usuario != null) {
    	    ...
    	    leu.setLeuValornuevo("accede a Configuración de analizadores");
