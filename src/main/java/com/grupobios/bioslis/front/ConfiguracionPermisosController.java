 ...
 */
@Controller
public class ConfiguracionPermisosController {
    
    ModelAndView mav = new ModelAndView();
    
    @RequestMapping("/ConfiguracionPermisos")
    public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
        ...
        mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_CONFIGURACION_PERMISOS);
      ...
      //aqui se inserta la accion que realiza usuario en modulos ***********            
        ...
        if(usuario != null) {
    	    ...
    	    leu.setLeuValornuevo("accede a Configuración de permisos");
