 ...
 */
@Controller
public class ConfiguracionSeccionesController {

	ModelAndView mav = new ModelAndView();

	@RequestMapping("/ConfiguracionSecciones")
        public ModelAndView pageLoad(HttpServletRequest request, HttpServletResponse response, RedirectAttributes attributes){
            ...
            mav = ConfigSingletonSession.getInstance().validarSesionUsuario(mav, sesion, attributes, ViewNames.ID_CONFIGURACION_SECCIONES);
            ...
            //aqui se inserta la accion que realiza usuario en modulos ***********               
              if(usuario != null) {
          	    ...
          	    leu.setLeuValornuevo("accede a Configuración de secciones");
